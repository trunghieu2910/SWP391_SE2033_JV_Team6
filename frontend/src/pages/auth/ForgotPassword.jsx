      ...
      <div className="card fp-card">
        ...
        {step === 0 && (
          <>
            <div className="fp-header">
              <h2>Quên mật khẩu</h2>
              <p className="text-muted">Nhập địa chỉ email đã đăng ký của bạn. Chúng tôi sẽ gửi mã OTP gồm 6 chữ số.</p>
            </div>
        ...
        {step === 1 && (
          <>
            <div className="fp-header">
              ...
              <p className="text-muted">Một mã gồm 6 chữ số đã được gửi đến <strong>{email}</strong>. Kiểm tra hộp thư đến của bạn.</p>
            </div>
        ...
        {step === 2 && !success && (
          <>
            <div className="fp-header">
              ...
              <p className="text-muted">Mật khẩu của bạn phải đáp ứng tất cả các yêu cầu dưới đây.</p>
            </div>
            {step3Err && (
        ...
        {success && (
          <div className="fp-success">
            ...
            <p className="text-muted">Bạn hiện đã có thể đăng nhập bằng mật khẩu mới.</p>
            <Link to="/login" className="btn btn-outline mt-24" style={{textDecoration:'none'}}>
