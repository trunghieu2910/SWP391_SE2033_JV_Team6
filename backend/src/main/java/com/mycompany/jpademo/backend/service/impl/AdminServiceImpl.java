...
import com.mycompany.jpademo.backend.util.PendingDoctorData;
import com.mycompany.jpademo.backend.util.PendingDoctorStore;
...
public class AdminServiceImpl implements AdminService {
    ...
    public ResponseEntity<String> verifyAndCreateDoctor(VerifyPendingDoctorRequest request, User admin) {
        ...
        boolean isOtpValid = com.mycompany.jpademo.backend.util.OtpUtil.verifyOtp(admin.getEmail(), otp);
        if (!isOtpValid) {
            throw new InvalidOtpException();
        }
        com.mycompany.jpademo.backend.util.OtpUtil.removeOtp(admin.getEmail());
    ...
    public InitiateCreateDoctorResponse initiateCreateDoctor(InitiateCreateDoctorRequest request, User admin) {
        ...
        String otpKey = admin.getEmail() + ":" + requestId;
        OtpUtil.saveOtp(otpKey, otp);
        emailService.sendEmail(
                admin.getEmail(),
