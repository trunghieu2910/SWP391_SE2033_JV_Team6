...
public class LabResultServiceImpl implements LabResultService {
    ...
    @Override
    @LogActivity(action = "CREATE_LAB_RESULT", targetType = "LabResults", description = "Bác sĩ tạo kết quả xét nghiệm")
    ...
    @Override
    @LogActivity(action = "GET_LAB_RESULTS_BY_SESSION", targetType = "DiagnosisSession", description = "Lấy kết quả xét nghiệm theo phiên khám")
    public List<LabResultResponse> getLabResultsBySession(Integer sessionId) {
        ...
        AuditLogContext.setTargetId(sessionId);
